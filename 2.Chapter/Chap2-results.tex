...
To illustrate this, the masks of the events that occurred closest to the juxta spikes were calculated. 

The average of these masks is presented in Fig. REFERENCE. The maximum value for the standard deviation of the average was $8.52 x 10^{-5}$ which is very low and therefore it is fair to say that most of the masks of the juxta spike are in this collection.

Examples of these mask are in Fig. REFERENCE 

Looking at the mask of the NUMBER or NUMBER it is easily seen that there are connected components from one/two spikes other than the one from the juxta neuron that were merged together.

This situation could possibly be solve increasing the weak threshold, however this would lead to an increase of false negatives. 
